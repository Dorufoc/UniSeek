...
export const getRealNameAuthStatus = () =>
  request.get<any, RealNameAuthStatus>('/auth/real-name/status')

/** 修改密码 PUT /api/auth/password */
export const changePassword = (params: ChangePasswordParams) =>
  request.put<any, void>('/auth/password', params)

/** PUT /api/auth/phone 修改手机号 */
export const updatePhone = (params: { newPhone: string; password: string }) =>
  request.put<any, void>('/auth/phone', params)

/** PUT /api/auth/email 修改邮箱 */
export const updateEmail = (params: { newEmail: string; password: string }) =>
  request.put<any, void>('/auth/email', params)

/** GET /api/auth/current-user 获取当前用户信息 */
export const getCurrentUser = () =>
  request.get<any, UserInfo>('/auth/current-user')
