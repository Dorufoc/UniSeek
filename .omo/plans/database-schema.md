...
- Evidence: .omo/evidence/task-<N>-database-schema.<ext>
...
- [ ] 1. <title>
  ...
  QA scenarios (name the exact tool + invocation): happy + failure, Evidence .omo/evidence/task-1-database-schema.<ext>
